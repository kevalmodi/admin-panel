<div class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                Admin<i class="clip-clip"></i>Side
            </a>
                <!-- end: LOGO -->
            </div>
            <div class="navbar-tools">
                ...
                <ul class="nav navbar-right">
                                    ...
                                    <ul>
                                            ...
                                            <a href="javascript:;">
                                                <div class="clearfix">
                                                    <div class="thread-image">
                                                        <img alt="" src="${pageContext.request.contextPath }/adminResources/image/avatar-2.jpg">
                                                    </div>
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <div class="clearfix">
                                                    ...
                                                    <div class="thread-content">
                                                        <span class="author">Aniket Shah</span>
                                                        <span class="preview">Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</span>
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <div class="clearfix">
                                                    <div class="thread-image">
                                                        <img alt="" src="${pageContext.request.contextPath }/adminResources/image/avatar-5.jpg">
                                                    </div>
                                                    <div class="thread-content">
                    ...
                    <li class="dropdown current-user">
                        <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
                            <img src="${pageContext.request.contextPath }/adminResources/image/avatar-1-small.jpg" class="circle-img" alt="">
                            <span class="username">Aniket Shah</span>
