...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <h2><i class="fa fa-pencil-square teal"></i>Manage Dataset</h2>
                                
                                <hr>
                                  <!-- form tag spring insertdataset-->
                                <%@taglib prefix="spring"  uri="http://www.springframework.org/tags/form"%>
                                
                                
                                <spring:form action="insertDataset" role="form" id="form" method="get" modelAttribute="modeldatasetinsert">
                                    <div class="row">
                                        <!-- <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Filename <span class="symbol required"></span>
                                                </label>
                                                
                                                <spring:input  placeholder="Insert subject" class="form-control"  path="filename"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">File Description <span class="symbol required"></span>
                                                </label>
                                                <spring:input  placeholder="Insert Description" class="form-control"  path="filedescription"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label"> Attachment <span class="symbol required"></span>
                                                </label>
                                                <input type="file" placeholder="upload file" class="form-control" id="attachment" name="attachment">
                                            </div>
 ...
 -->                                        
 									<div class="col-md-4">
                                      <!-- <button class="btn btn-yellow btn-block" type="submit"> submit<i class="fa fa-arrow-circle-right"></i> -->
