...
<body class="login example1">
    ...
    <div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
        ...
        <div class="box-login">
            ...
            <f:form class="form-login" action="checkuserpassword" method="get" modelAttribute="forgotpassworduser">
                <div class="errorHandler alert alert-danger no-display">
                    <i class="fa fa-remove-sign"></i> You have some form errors. Please check below.
                </div>
                <fieldset>
                    <div class="form-group">
                        Username:<span class="input-icon">
                            <f:input class="form-control" id="username" path="username"  placeholder="Username"></f:input>
