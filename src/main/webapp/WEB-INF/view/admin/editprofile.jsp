...
<body class="login example1" style="background-color: #ad9fa85c">
    ...
    <div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
        ...
        <div class="box-login">
            ...
            <sp:form class="form-register" action="/admin/registerupdate" modelAttribute="registerupdate" method="get">
                ...
                <fieldset>
                    ...
                    <sp:hidden path="registerId"/>
                    <sp:hidden path="loginVO.loginId"/>
                    <sp:hidden path="loginVO.enabled"/>
                    <sp:hidden path="loginVO.role"/>
                    <div class="form-group">
