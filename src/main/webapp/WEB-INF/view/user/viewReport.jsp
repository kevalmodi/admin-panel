...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="adminResources/css/all.css" />
    ...
    <link type="text/css" rel="stylesheet" id="skin_color" href="adminResources/css/theme/light.min.css" />
    <!-- end: MAIN CSS -->
    <!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
    <link href="adminResources/css/select2.min.css" rel="stylesheet" />
    <link href="adminResources/css/dataTables.bootstrap.min.css" rel="stylesheet" />
...
<body>
                ...
                <div class="row">
                    ...
                    <option value="fixed">Fixed</option>
                                ...
                                <div class="images boxed-patterns">
                                    <a id="bg_style_1" href="#"><img alt="" src="adminResources/image/bg.png"></a>
                                    <a id="bg_style_2" href="#"><img alt="" src="adminResources/image/bg_2.png"></a>
                                    <a id="bg_style_3" href="#"><img alt="" src="adminResources/image/bg_3.png"></a>
                                    <a id="bg_style_4" href="#"><img alt="" src="adminResources/image/bg_4.png"></a>
                                    <a id="bg_style_5" href="#"><img alt="" src="adminResources/image/bg_5.png"></a>
                                </div>
                                <div class="box-title">
                                    5 Predefined Color Schemes
                                </div>
                                <div class="images icons-color">
                                    <a id="light" href="#"><img class="active" alt="" src="adminResources/image/lightgrey.png"></a>
                                    <a id="dark" href="#"><img alt="" src="adminResources/image/darkgrey.png"></a>
                                    <a id="black-and-white" href="#"><img alt="" src="adminResources/image/blackandwhite.png"></a>
                                    <a id="navy" href="#"><img alt="" src="adminResources/image/navy.png"></a>
                                    <a id="green" href="#"><img alt="" src="adminResources/image/green.png"></a>
                                </div>
                ...
                <div class="tab-pane active" id="users">
                    <div class="users-list">
                        ...
                        <ul class="media-list">
                            <li class="media">
                                <a href="#">
                                    ...
                                    <img alt="..." src="adminResources/image/avatar-2.jpg" class="media-object">
                            ...
                            <li class="media">
                                <a href="#">
                                    ...
                                    <i class="fa fa-circle status-online"></i>
                                    <img alt="..." src="adminResources/image/avatar-3.jpg" class="media-object">
                                    <div class="media-body">
                            ...
                            <li class="media">
                                <a href="#">
                                    <i class="fa fa-circle status-online"></i>
                                    <img alt="..." src="adminResources/image/avatar-4.jpg" class="media-object">
                                    <div class="media-body">
                            ...
                            <li class="media">
                                <a href="#">
                                    <i class="fa fa-circle status-online"></i>
                                    <img alt="..." src="adminResources/image/avatar-5.jpg" class="media-object">
                                    <div class="media-body">
                        ...
                        <ul class="media-list">
                            <li class="media">
                                <a href="#">
                                    <img alt="..." src="adminResources/image/avatar-6.jpg" class="media-object">
                                    <div class="media-body">
                                        <h4 class="media-heading">Nicole Bell</h4>
                                        <span> Content Designer </span>
                                    </div>
                            ...
                            <li class="media">
                                <a href="#">
                                    ...
                                    <img alt="..." src="adminResources/image/avatar-7.jpg" class="media-object">
                                    <div class="media-body">
                                        <h4 class="media-heading">Steven Thompson</h4>
                                        <span> Visual Designer </span>
                                    </div>
                            ...
                            <li class="media">
                                <a href="#">
                                    <img alt="..." src="adminResources/image/avatar-8.jpg" class="media-object">
                                    <div class="media-body">
                                        <h4 class="media-heading">Ella Patterson</h4>
                                        <span> Web Editor </span>
                                    </div>
                            ...
                            <li class="media">
                                <a href="#">
                                    <img alt="..." src="adminResources/image/avatar-9.jpg" class="media-object">
                                    <div class="media-body">
                                        <h4 class="media-heading">Kenneth Ross</h4>
                                        <span> Senior Designer </span>
                                    </div>
                            ...
                            <li class="media">
                                <a href="#">
                                    <img alt="..." src="adminResources/image/avatar-10.jpg" class="media-object">
                                    <div class="media-body">
                                        <h4 class="media-heading">Ella Patterson</h4>
                                        <span> Web Editor </span>
                                    </div>
    ...
    <script src="adminResources/js/bootbox.js"></script>
    <script src="adminResources/js/jquery.mockjax.min.js"></script>
    ...
    <script src="adminResources/js/table-data.min.js"></script>
