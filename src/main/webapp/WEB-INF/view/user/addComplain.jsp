                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <sp:form action="/user/insertComplain" method="post" role="form" modelAttribute="modelinsertcomplain" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <sp:input placeholder="Insert subject" class="form-control" id="firstname" path="complainsubject"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">
                                                    Description <span class="symbol required"></span>
                                                </label>
                                                <sp:input placeholder="Insert Description" class="form-control" id="description" path="complaindescription"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">	
                                                    Attachment <span class="symbol required"></span>
                                                </label>
                                                <input type="file" placeholder="upload file" class="form-control" id="attachment" name="file">
                                            </div>
