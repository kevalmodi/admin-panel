...
<script type="text/javascript">
	...
	function fn1 (){
		...
		htp.open("get","http://127.0.0.1:4042/",true);
		htp.send();
	}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <h2><i class="fa fa-pencil-square teal"></i>Availability of Teacher in Classroom</h2>
                               ...
                               <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input class="btn btn-yellow btn-block" type="button" value="Availability of Teacher" onclick="fn1()">
